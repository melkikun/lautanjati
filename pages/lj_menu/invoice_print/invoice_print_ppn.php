                ...
                <div id="customer">
                    <div>
                        <div style="width: 30.33%; float: left;">
                            <img id="image" src="images/logo.png" alt="logo" height="107px" width="240px" style=""/>
                    ...
                    <div style="width: 99%; float: left; margin-top: -5px;" id="content">
                        <table id="items" style="margin: 10px 0 0 0;">
                            ...
                            <tr>
                                ...
                                <td colspan="3" style="font-size: 13px; font-weight: bold; text-align: right;">
                                    <?php
                                    $ppn = ($total_harga - $total_discount) * 10 / 100;
                                    if ($looping == 2 || $looping == 4) {
                                        echo "";
                                    } else {
                                        echo "Rp. " . number_format(round($ppn), 2);
                                    }
                                    ?>
                                </td>
                            </tr>
                                ...
                                <td style="text-align: right; font-size: 13px;">
                                    <b>
                                        ...
                                        if ($looping == 2 || $looping == 4) {
                                            ...
                                            echo number_format(round($total_harga - $total_discount + $ppn), 2);
                                        }
                                        ?>
                                    </b>
                                </td>
                            ...
                            <tr id="hiderow">
                                <td colspan="12" style="font-size: 11px; font-weight: normal;">
                                    ...
                                    if ($looping == 2 || $looping == 4) {
                                        ...
                                        echo "<b>Terbilang</b> : &nbsp;#<i>" . terbilang(round($total_harga - $total_discount + $ppn)) . " Rupiah</>#";
                                    }
                                    ?>
                                </td>
                            </tr>
