...
<html moznomarginboxes mozdisallowselectionprint>
    <head>
        ...
        <style>
            ...
            @page 
            {
                ...
                margin: 0.4cm 0.4cm 0.4cm 0.4cm;  /* this affects the margin in the printer settings */
            }
    ...
    <body onload="window.print();">
        <?php
        for ($looping = 1; $looping <= 4; $looping++) {
            ?>
            <div id="page-wrap" style="page-break-after: always;">
                <div id="customer">
                    <div>
                        <div style="width: 30.33%; float: left;">
                            ...
                            if ($looping == 4) {
                                ...
                                if ($looping == 1) {
                                    echo '<img id="image" src="images/invoice_1-01.png" alt="logo" height="80px" style="margin-left:10px; margin-top:15px;" />';
                                } else if ($looping == 2) {
                                    echo '<img id="image" src="images/invoice_2-01.png" alt="logo" height="80px" style="margin-left:12px; margin-top:15px;"/>';
                                } else if ($looping == 3) {
                                    echo '<img id="image" src="images/invoice_3-01.png" alt="logo" height="80px" style="margin-left:6px; margin-top:15px;"/>';
                                }
                            }
                            ?>
                        </div>
                        <div style="width: 33.33%; float: left;">
                            <?php
                            if ($looping == 1) {
                                echo '<span style="color: transparent;">ss</span>';
                            } else if ($looping == 2) {
                                echo '<span style="color: transparent;">ss</span>';
                            } else if ($looping == 3) {
                                echo '<span style="color: transparent;">ss</span>';
                        ...
                        <div style="width: 35.33%; float: left;">
                    ...
                    <div style="width: 99%; float: left; margin-top: -5px;" id="content">
                                ...
                                if ($response[0]['INVOICE_DISC_TYPE'] == "persen") {
                                    ...
                                    <td colspan="2" style="font-size: 13px; font-weight: bold; text-align: right;">
                                        ...
                                        if ($looping == 2) {
                                            ...
                                            echo number_format($response[0]['INVOICE_DISC'], 2) . " %";
                                        }
                                        ?>
                                    </td>
                                ...
                                <td style="text-align: right; font-size: 13px;">
                                    <b>
                                        ...
                                        if ($looping == 2) {
                                            ...
                                            echo number_format(round($total_harga - $total_discount), 2);
                                        }
                                        ?>
                                    </b>
                                </td>
                            ...
                            <tr id="hiderow">
                                <td colspan="12" style="font-size: 11px; font-weight: normal;">
                                    ...
                                    if ($looping == 2) {
                                        ...
                                        echo "<b>Terbilang</b> : &nbsp;#<i>" . terbilang(round($total_harga - $total_discount)) . " Rupiah</>#";
                                    }
                                    ?>
                                </td>
                            </tr>
                    ...
                    if ($looping == 4) {
                        ?>
                        <div style="width: 99%; float: left; margin-top: 2px;" id="footer">
                            <table id="items" style="margin: 1px 0 0 0;">
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center; font-size: 11px;"><b>DAVID</b></td>
                    ...
                    <?php } ?>
                    <div style="width: 99%; float: left; margin-top: 2px;" id="payterm">
