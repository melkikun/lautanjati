        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="row">
                        <div class="col-sm-12 text-center" style="color: red; font-size: 18px;">LAPORAN TOTAL OMSET PERUSAHAAN</div>
                    </div>
                    <hr>
                    <div class="row">
                        <div class="col-md-4">
                        ...
                        <div class="col-sm-12">                           
                            <div class="form-group">
                                <button type=" button" class="btn btn-warning btn-outline col-sm-12" onclick="LihatOmset();">LIHAT OMSET</button>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="row" id="hasil">
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="row">
                        <div class="col-sm-6 text-left" style="color: blue; font-size: 14px;">
...
<script src="pages/lj_menu/statistik/omset_kantor/control_omset_kantor.js"></script>
<script>
